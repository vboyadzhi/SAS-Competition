...
if __name__ == "__main__":
	...
	xgb_train = lgb.Dataset(train, label=target, feature_name='auto')

	num_boost_best = 923
	model_fit = lgb.train(params_lgb, xgb_train, num_boost_round=num_boost_best,  verbose_eval=False)

	with bz2.BZ2File('models/model_lgb.pbz2', 'w') as f:
